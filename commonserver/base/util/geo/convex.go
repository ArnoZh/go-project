...
type Convex struct {
	...
	MergeTriangles []int32   // 合成的三角形
	Type           int32     // 合成的三角形的type
	//EdgeIDs        []int32
	//WtCoord        Coord
}
...
//		logrus.Errorf("convex error not a convex d\n")
//		return false
//	}
//	count1 := len(vers)
...
//		if !value {
//			logrus.Errorf("convex error has not exist value %d\n", key)
//			return false
//		}
//	}
//
//	if count1 != count2 {
//		logrus.Errorf("convex error has not merged\nvertice convex vertices count: %d merge vertices count: %d\n", count1, count2)
//		return false
//	}
//	return true
//}
...
func (c *Convex) GetNeighborPoints(t2 *Convex) []Vertice {
