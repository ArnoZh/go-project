...
// NewClusterClient ..
func NewClusterClient(clusterSlots []redis.ClusterSlot) *redis.ClusterClient {
	clusterSlot := func() ([]redis.ClusterSlot, error) {
	...
	logrus.Infof("redis cluster: ping %v %v", res, err)
	return client
}
