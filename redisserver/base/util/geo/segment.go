...
func IsRectCross(p0, p1, q0, q1 Coord) bool {
	ret := util.MinInt32(p0.X, p1.X) <= util.MaxInt32(q0.X, q1.X) &&
		util.MinInt32(q0.X, q1.X) <= util.MaxInt32(p0.X, p1.X) &&
		util.MinInt32(p0.Z, p1.Z) <= util.MaxInt32(q0.Z, q1.Z) &&
		util.MinInt32(q0.Z, q1.Z) <= util.MaxInt32(p0.Z, p1.Z)
	return ret
}
